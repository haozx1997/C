...
void circle_cross_line(point2d a,point2d b,point2d c,point2d o,double r ,point2d ret[],int &num)
{
	double x0 = o.x,y0 = o.y;
	double x1 = a.x,y0 = a.y;
	double x2 = b.x,y0 = b.y;
	...
	if(dcmp(delta) >= 0)
	{
		...
		{
			ret[nu++] = point2d(x1 + t1*dx,y1 + t1*dy);
		}
...
double cala(const point2d &a,const point2d &b)
{
	point2d p[2];
	int num = 0;
